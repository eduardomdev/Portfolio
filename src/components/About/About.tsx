    ...
    return(
        <AboutMe>
            <TextAbout>
                ...
                <p>Me chamo Eduardo Maciel, tenho 22 anos, sou desenvolvedor Front End e estudante de Analise e Desenvolvimento de Sistemas. Tenho contato e afinidade com a tecnologia desde muito novo, por influência de meus irmãos mais velhos comecei a ter contato com computadores aos 7 anos e assim foi durante toda minha adolescência. Aos 18 anos a vida acabou me levando por outro caminho e fui estudar Nutrição, onde durante todo curso sempre senti que não fazia parte daquilo, que faltava algo e foi então por influência de um primo desenvolvedor que resolvi, no último ano de faculdade, trocar de área e dar uma chance a tecnologia, que durante toda minha vida fez parte de mim e hoje posso dizer que me encontrei nos códigos, onde tenho a determinação e a motivação para exercer com excelência aquilo que amo!
                <br />
                <br />
